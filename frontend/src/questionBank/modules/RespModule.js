...
export const RespModule = [
  ...
  // ======================
  { id: "prom_sob", type: "yes_no_toggle" },
  { id: "confirm_sob", type: "radio_group", options: ["Remove", "Proceed"] },
  ...
  // COUGH
  // ======================
  { id: "prom_cough", type: "yes_no_toggle" },
  { id: "confirm_cough", type: "radio_group", options: ["Remove", "Proceed"] },
